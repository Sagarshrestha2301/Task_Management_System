...
export async function getNextIssueNumber(projectId) {
...
export async function getIssueById(projectId, issueId, userId) {
...
export async function deleteIssue(projectId, issueId, actorId) {
  const issue = await prisma.issue.findFirst({
    where: { id: issueId, projectId, deletedAt: null },
  });
  if (!issue) throw new Error("NOT_FOUND");
...
export async function addLabels(projectId, issueId, actorId, labelIds) {
  const issue = await prisma.issue.findFirst({
    where: { id: issueId, projectId, deletedAt: null },
  });
  if (!issue) throw new Error("NOT_FOUND");
...
export async function removeLabel(projectId, issueId, actorId, labelId) {
  const issue = await prisma.issue.findFirst({
    where: { id: issueId, projectId, deletedAt: null },
  });
  if (!issue) throw new Error("NOT_FOUND");
